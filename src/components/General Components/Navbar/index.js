    ...
    return(
        <div className="big-nav">
            ...
            <div className="section2">
                <div style={active==0 ? {boxShadow:"0px 0px 10px 4px #DBDBDB", backgroundColor:"white"} :null}>
                    <h6>Where</h6>
                    <input onClick={()=>setActive(0)} style={active==0 ? {backgroundColor:"white"}:null} type="text" placeholder="Search destinations"/>
                </div>
                <div style={active==1 ? {boxShadow:"0px 0px 10px 4px #DBDBDB", backgroundColor:"white"} :null}>
                    <h6>When</h6>
                    <input onClick={()=>setActive(1)} style={active==1 ? {backgroundColor:"white"}:null} type="text" placeholder="Any week"/>
                </div>
                <div style={active==2 ? {boxShadow:"0px 0px 10px 4px #DBDBDB", backgroundColor:"white"} :null}>
                    <h6>Who</h6>
                    <input onClick={()=>setActive(2)} style={active==2 ? {backgroundColor:"white"}:null} type="text" placeholder="Add guests"/>
                </div>
                <div></div>
            </div>
        </div>
