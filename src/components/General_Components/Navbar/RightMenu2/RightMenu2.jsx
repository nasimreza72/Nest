...
const RightMenu2 = ()=>{
    ...
    useEffect(() => {
        document.addEventListener("mousedown", (e) => {
            const rightMenu2Container = document.querySelector(".right-menu2-container")
            if(!rightMenu2Container)return
            if(!rightMenu2Container.contains(e.target)) setRightMenu(false);
        })
      }, [])
    return(
